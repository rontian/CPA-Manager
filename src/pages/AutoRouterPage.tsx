  ...
  return (
    <>
                    ...
                    <div className={styles.modelCard} key={`${model.name}-${modelIndex}`}>
                      <div className={styles.cardHeader}>
                        <div>
                          ...
                          <p>
                            {model.description || t('auto_router.model_description_placeholder')}
                          </p>
                        </div>
                        <Button
                          variant="danger"
      ...
      <Modal
        ...
        title={t('auto_router.presets_title')}
        onClose={() => setPresetModalOpen(false)}
        width="min(1120px, calc(100vw - 40px))"
        className={styles.presetsModal}
      >
        <div className={styles.presetsModalContent}>
          <div className={styles.panelHeader}>
            <div>
